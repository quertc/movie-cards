<template>
  <nav class="nav">
    ...
    <div class="nav__discover-menu">
      ...
      <a href="" class="nav__discover-menu-link nav-discover-menu-link_active">
      ...
      <a href="" class="nav__discover-menu-link">
      ...
      <a href="" class="nav__discover-menu-link" v-for="genre in genresList" :key="genre.id">
