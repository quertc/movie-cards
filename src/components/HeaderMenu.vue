<template>
  <nav class="nav">
    ...
    <div class="nav__discover-menu">
      ...
      <router-link :to="{ name: 'genres', params: { genre: genre.name.replace(/ /g, '_').toLowerCase() }}" class="nav__discover-menu-link" v-for="genre in genresList" :key="genre.id" @click.native="$emit('close-menu')">
