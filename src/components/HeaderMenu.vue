<template>
  <nav class="nav">
    ...
    <div class="nav__discover-menu">
      ...
      <router-link :to="{ name: 'discover', params: { type: 'Popular' }}" class="nav__discover-menu-link" @click.native="$emit('close-menu')">
      ...
      <router-link :to="{ name: 'discover', params: { type: 'Top Rated' }}" class="nav__discover-menu-link" @click.native="$emit('close-menu')">
      ...
      <router-link :to="{ name: 'discover', params: { type: 'Upcoming' }}" class="nav__discover-menu-link" @click.native="$emit('close-menu')">
      ...
      <router-link :to="{ name: 'genres', params: { genre: genre.name }}" class="nav__discover-menu-link" v-for="genre in genresList" :key="genre.id" @click.native="$emit('close-menu')">
...
export default {
  ...
  async created() {
    try {
      let response = await fetch(`https://api.themoviedb.org/3/genre/movie/list?api_key=${process.env.VUE_APP_SECRET}&language=en-US`);
